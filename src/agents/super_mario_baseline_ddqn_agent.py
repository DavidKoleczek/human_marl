...
from policy.super_mario_shared_autonomy_policy import SharedAutonomyPolicy
...
def baseline_DDQN_agent(
    ...
    def _ddqn(env, writer=DummyWriter()):
        ...
        return baseline_DDQN(q, policy, replay_buffer,
