...
# def super_mario_co_ddqn(env):
#     class Super_Mario_CoNet(nn.Module):
#         def __init__(self):
#             super().__init__()

#             self.conv1 = nn.Conv2d(env.observation_space.shape[0], 32, 3, stride=2, padding=1)
...
#             self.linear4 = nn.Linear(64, env.action_space.n)
