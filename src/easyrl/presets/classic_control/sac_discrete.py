...
from easyrl.agents import SACDiscrete
from easyrl.approximation import QContinuous, PolyakTarget, VNetwork
from easyrl.logging import DummyWriter
from easyrl.memory import ExperienceReplayBuffer
from easyrl.bodies import TimeFeature
from easyrl.policies import SoftDeterministicDiscretePolicy

from easyrl.approximation.sac_discrete_approx import fc_q_discrete, fc_v_discrete, fc_soft_policy_discrete


def sac_discrete_preset(
        env,
        # Common settings
        device="cuda",
        ...
        # Model construction
        q1_model_constructor=fc_q_discrete,
        q2_model_constructor=fc_q_discrete,
        v_model_constructor=fc_v_discrete,
        policy_model_constructor=fc_soft_policy_discrete,
        writer=DummyWriter()
):
    """
    ...
    policy = SoftDeterministicDiscretePolicy(
        policy_model,
        policy_optimizer,
        env.action_space,
        scheduler=CosineAnnealingLR(
    ...
    return TimeFeature(SACDiscrete(
        policy,
        q_1,
        q_2,
        v,
        ...
        entropy_target=(-env.action_space.n * entropy_target_scaling),
